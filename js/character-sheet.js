                ...
                ${(function() {
                  ...
                  for (const [slot, itemName] of Object.entries(char.equipment || {})) {
                    ...
                    if (item && item.damageDie) {
                      ...
                      if (vanguardCritBonus > 0) maxCritCap += vanguardCritBonus;
